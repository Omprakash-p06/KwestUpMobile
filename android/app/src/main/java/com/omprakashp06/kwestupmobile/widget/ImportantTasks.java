...
/**
 * ImportantTasks widget provider.
 *
 ...
 * from widgetprovider_importanttasks.xml. Values are only written when the
 * existing options are 0 or absent, so real Android-measured sizes always take
 * precedence.
 */
public class ImportantTasks extends RNWidgetProvider {

    /** Minimum dimensions from widgetprovider_importanttasks.xml */
